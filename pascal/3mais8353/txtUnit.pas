	...
	type
		...
		txt = object
			...
			public
				...
				//Pasiruoðia darbo pradþiai

				constructor fConstructor(strFilename : string);
				//Pasiruoðia darbo pradþiai bei atidaro failà skaitymui
				//Parametrai:
				//    strFailas -  failo pavadinimas

				destructor fDestructor;
				//Gràþina á pradinæ bûsena bei uþdaro failà, jei jis buvo atidarytas
				...
				//Funkcija grazina paveikslo (URL_PHOTO) vardà
